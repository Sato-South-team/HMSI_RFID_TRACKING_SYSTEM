...
namespace DATA_LAYER.DatabaseConnectivity
{
    public class DatabaseConnections
    {
        ...
        public bool Connect()
        {
            try
            {
                strSqlConn = "Data Source=" + ENTITY_LAYER.Entity_Layer.Entity_Layer.SqldbServer + ";initial catalog=" + ENTITY_LAYER.Entity_Layer.Entity_Layer.SqlDBName + "; Integrated Security=false;User ID=" + ENTITY_LAYER.Entity_Layer.Entity_Layer.SqlDBUserID + ";PWD=" + ENTITY_LAYER.Entity_Layer.Entity_Layer.SqlDBPassword;
